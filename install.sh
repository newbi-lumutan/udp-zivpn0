...
function show_expired_message_and_exit() {
    ...
    echo -e "silakan hubungi admin https://t.me/sweaterpinks \n"
...
function show_menu() {
    ...
    echo -e "${YELLOW}┌─────────────────// ${CYAN}LUXXX STORE${YELLOW} //──────────────────┐${NC}"
    _draw_info_panel
...
# Hapus rule yang redirect banyak port ke 36712
